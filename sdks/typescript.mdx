---
title: "TypeScript SDK: Proof Exchange Client and All Exports"
...
| `sign` | `(privateKey: Uint8Array, message: Uint8Array) → Uint8Array` | Sign and return a 64-byte Ed25519 signature |
| `verify` | `(pubkey: Uint8Array, signature: Uint8Array, message: Uint8Array) → boolean` | Verify an Ed25519 signature |
