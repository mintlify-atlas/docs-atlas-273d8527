...
description: "Reference for all TypeScript query response types returned by the Proof Trading SDK, including orderbook, account, position, market config, and history shapes."
---
